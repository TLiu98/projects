    ...
    <div class="biaoti center">
        <table>
            <tr><th><img src="./image/logo.png" alt=""></th>
                <th><font size="5px"><%=request.getParameter("information")%></font></th></tr>
        </table>
    </div>
        ...
        <div class="left fl">
            ...
            <div class="fl">
                <ul>
                        ...
                        <li style="margin-top:13px" title="点击后恢复综合排序"><a href="findbylike.action?information=<%=information %>">综合排序</a></li>
                        <li style="margin-top:13px">|</li>
                              <li style="margin-top:13px" title="点击后按价格升序"><a href="findbylike.action?information=<%=information %>&asc=1"  >按价格升序</a></li>

                    <li style="margin-top:13px">|</li>
                    <li style="margin-top:13px" title="点击后按价格降序"><a href="findbylike.action?information=<%=information %>&desc=1">按价格降序</a></li>
...
<%-- <a href="findbytype.action?book.type=<%=request.getParameter("book.type")%>&book_type_name=<%=book_type_name %>&minPrice=1&maxPrice=30">区间查询</a> --%>
    ...
    <li>
      <input type="text" id="minPrice" placeholder="最低价" required="required" style="width:50px;height:20px">
                  	...
                  	<input type="button" class="butn1" value="确认" style="width:50px;height:20px" >
...
<!--    <li style="margin-top:13px"><a href="./dingdanzhongxin.jsp" target="_blank" >促销</a></li> -->
    ...
    <div class="main center">
        ...
        <s:if test="msg == '非常抱歉，没有查询到任何结果。'">
            <font color="red" size="4"><s:property value="msg"/></font>
            <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.jsp">返回主页</a>
        </s:if>
        <s:else>
        "<font color="red" size="4"><%=request.getParameter("information")%></font>",<s:property value="msg"/><br>
        <s:iterator value="likeList" var="book">
...
$(document).ready(function(){
    $(".butn").click(function(){
 	 alert("点击事件");    
   	 ...
   	 alert(information+"11");   
<%--     	var typename="<%=request.getParameter("book_type_name")%>";  --%>

 	 window.location.href="findbylike.action?information="<%=information %>"&minPrice="+minPrice+"&maxPrice="+maxPrice;
